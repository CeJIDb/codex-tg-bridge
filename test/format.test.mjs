...
const cases = [
  ...
  {
    name: "md-таблица 2 колонки → список (шапка-названия колонок отбрасывается)",
    in: "| Индикатор | Цвет |\n|---|---|\n| Пожар | красный |\n| АПС | желтый |",
    out: "• <b>Пожар</b> — красный\n• <b>АПС</b> — желтый",
  },
  {
    name: "md-таблица 3 колонки → multi-line блок",
    in: "| Имя | Тип | Цвет |\n|---|---|---|\n| Пожар | критич | красный |\n| Вода | предупр | желтый |",
    outIncludes: [
      "• <b>Пожар</b>",
      "  Тип: критич",
      "  Цвет: красный",
  ...
  {
    name: "таблица внутри блока кода не трогается",
    in: "до\n```\n| a | b |\n|---|---|\n| 1 | 2 |\n```\nпосле",
    out: "до\n<pre>| a | b |\n|---|---|\n| 1 | 2 |</pre>\nпосле",
  },
  {
    name: "текст вокруг таблицы сохраняется",
    in: "Перед таблицей.\n\n| K | V |\n|---|---|\n| a | b |\n\nПосле таблицы.",
    outIncludes: ["Перед таблицей.", "• <b>a</b> — b", "После таблицы."],
  },
  {
    name: "одиночная вертикальная черта без разделителя не считается таблицей",
    in: "выбор: красный | желтый",
    out: "выбор: красный | желтый",
  },
];
